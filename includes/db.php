...
function seedDatabase(PDO $pdo): void
{
    ...
    $pdo->exec("INSERT INTO products (category_id, name, slug, price, sale_price, description, image, is_hit, is_premium, show_in_upsell, sort) VALUES
        ...
        (4, 'Авторский букет «Кремовый сон»', 'avtorskij-kremovyj-son', 5400, NULL, 'Ранункулюсы и лизиантусы в шёлковой обёртке — нежная авторская композиция.', 'gen15.jpg', 0, 1, 0, 180),
        (5, '25 роз и гортензии в шляпной коробке', '25-roz-gortenzii-korobka', 9500, NULL, 'Пышная композиция в круглой коробке с атласной лентой — вау-подарок без упаковки.', 'gen16.jpg', 0, 1, 0, 190),
        (4, 'Букет на годовщину «Красное и белое»', 'buket-godovshina-krasnoe-beloe', 4500, NULL, 'Красные и белые розы с гипсофилой — классика юбилея отношений.', 'gen17.jpg', 1, 0, 0, 200),
        (1, '25 красных роз в чёрно-золотой обёртке', '25-roz-cherno-zoloto', 6900, NULL, 'Премиальная упаковка матовый чёрный + золото — страстный жест.', 'gen18.jpg', 0, 1, 0, 210),
        (5, 'Орхидеи и розы в квадратной коробке', 'orhidei-rozy-kvadrat-korobka', 7900, NULL, 'Белые орхидеи с розами — статусная композиция для делового подарка.', 'gen19.jpg', 0, 1, 0, 220),
        (6, 'Клубника и макаруны в розовой коробке', 'klubnika-makarony-korobka', 1490, NULL, 'Клубника в шоколаде и макаруны — сладкое дополнение к букету.', 'gen20.jpg', 0, 0, 1, 230)");
