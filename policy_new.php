...
<main id="main" class="doc-page">
  <div class="wrap doc-page__inner">
    ...
    <div class="doc-page__card">
      ...
      <p>Мы не продаём и не передаём персональные данные третьим лицам, кроме случаев, необходимых для исполнения заказа: платёжному провайдеру (при онлайн-оплате) и курьерской доставке (имя, телефон и адрес получателя). Аналитика посещений сайта осуществляется через Яндекс.Метрику (ООО «ЯНДЕКС.МЕТРИКА») — после вашего согласия в cookie-баннере; собранные данные обезличены.</p>
