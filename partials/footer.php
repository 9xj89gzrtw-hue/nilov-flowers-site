...
<footer class="site-footer" id="contacts">
  <div class="wrap">
    ...
    <span>© <?= date('Y') ?> <?= e($siteName) ?><?= setting('feature_track_link', '1') === '1' ? ' · <a href="/track">Где мой заказ?</a>' : '' ?> · <a href="/policy">Политика ПД</a> · <a href="/offer">Оферта</a></span>
  </div>
</footer>
  ...
  <aside class="cart-panel__drawer" role="dialog" aria-modal="true" aria-label="Корзина">
    ...
    <div class="cart-panel__foot">
      ...
      <div class="cart-promo" id="cartPromo">
        ...
        <button type="button" id="cartPromoApply" class="cart-promo__btn" style="padding:10px 14px;border:1px solid var(--line);border-radius:10px;background:#fff;font:600 .85rem var(--font-ui);cursor:pointer">Применить</button>
      </div>
